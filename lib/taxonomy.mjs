 ...
 *
 * The panel used to render each of those as one flat list. Past a hundred-odd
 * skills that is not an inventory, it is a wall: you cannot see that you own
 * four things which all fire on "something is broken", or that nothing at all
 * covers a stage. Clusters give the list a spine.
 *
